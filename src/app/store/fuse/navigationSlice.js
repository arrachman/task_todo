...
export const selectNavigation = createSelector(
	...
	(navigation, language, userRole) => {
		...
		return setTranslationValues(
			_.merge(
				[],
				// FuseUtils.filterRecursive(navigation, item => { console.log('item',item.auth,userRole,FuseUtils.hasPermission(item.auth, userRole)); FuseUtils.hasPermission(item.auth, userRole);  })
